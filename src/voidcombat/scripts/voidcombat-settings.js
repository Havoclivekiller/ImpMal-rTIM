export class VoidcombatSettings extends HandlebarsApplicationMixin(ApplicationV2)
{
    ...
    static #schema = new foundry.data.fields.SchemaField({
        ...
        voidshipSizeBonus : new foundry.data.fields.StringField({
            initial : "default", 
            label : "IMPMAL_RTIM.VoidCombat.Settings.VoidshipSizeBonus.Label", 
            hint :"IMPMAL_RTIM.VoidCombat.Settings.VoidshipSizeBonus.Hint"
        }),
        autoDefeated : new foundry.data.fields.BooleanField({
            initial : true, 
            label : "IMPMAL_RTIM.VoidCombat.Settings.AutoDefeated.Label", 
            hint :"IMPMAL_RTIM.VoidCombat.Settings.AutoDefeated.Hint"
        }),
        floorMovementPoints : new foundry.data.fields.BooleanField({
            initial : true, 
            label : "IMPMAL_RTIM.VoidCombat.Settings.FloorMovementPoints.Label", 
            hint :"IMPMAL_RTIM.VoidCombat.Settings.FloorMovementPoints.Hint"
        }),
        increaseAPCost : new foundry.data.fields.BooleanField({
            initial : true, 
            label : "IMPMAL_RTIM.VoidCombat.Settings.IncreaseAPCost.Label", 
            hint :"IMPMAL_RTIM.VoidCombat.Settings.IncreaseAPCost.Hint"
        }),
    ...
    async _prepareContext(options) {
        ...
        context.sizeLabels = {
            default : "IMPMAL_RTIM.VoidCombat.Settings.VoidshipSizeBonus.Default",
            shipDiff : "IMPMAL_RTIM.VoidCombat.Settings.VoidshipSizeBonus.ShipDiff",
            shipDiffAll : "IMPMAL_RTIM.VoidCombat.Settings.VoidshipSizeBonus.ShipDiffAll",
            noDamage : "IMPMAL_RTIM.VoidCombat.Settings.VoidshipSizeBonus.NoDamage"
        };
